...
def save_to_csv(trades, filename):
    ...
    with open(filename, 'w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
        writer.writerow(['Timestamp', 'Buyer_Wallet', 'Token_Amount', 'USD_Value', 'Transaction_Signature', 'Signer'])
        ...
        for trade in trades:
            writer.writerow([
                ...
                trade['Trade']['Amount'],
                trade['Trade']['Side']['AmountInUSD'] if trade['Trade']['Side']['AmountInUSD'] else 0,
